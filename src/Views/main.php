...
<div class="mainbox">
    ...
    <section class="services container">
        ...
        <div class="text-center container service-text">
            ...
            <div>
                <p> Компания Homemars готова оказать нашим клиентам комплексные услуги, связанные с покупкой и арендой недвижимости, а также её обслуживанием.
                Мы всегда готовы помочь во всём, что связано с жизнью и отдыхом на Марсе.</p>
            </div>
        
            <div class="flex-row container space-between service_box">
        
                <div class ="text-center service">
                    <div>
                        <h4>ПОКУПКА</h4>
                        <h3>Земельного участка</h3>
                    </div>
                    <div>
                        <img src="/static/img/land.jpg">
                    </div>
                    <div>
                ...
                <div class="service text-center">
                    ...
                    <a href="/services/<?echo $house['name']?>" class="a_button">Подробнее>>></a>
                </div>
        
                <div class="service text-center">
                    <div>
                        <h4>АРЕНДА</h4>
                        <h3>Квартир на Марсе</h3>
                    </div>
                    <div>
                        <img src="/static/img/pic3.jpg" class="imgscene">
                    </div>
                    <div>
                        <p>Поможем снять любую квартиру на Марсе на любой срок по цене от €20</p>
                        <p>Это быстро, выгодно, надёжно!</p>
                    </div>
                    <? foreach ($allFlats as $flat):?><?endforeach?>
                    <a href="/services/<?echo $flat['name']?>" class="a_button">Подробнее>>></a>
                </div>
            </div>
        </div>
    </section>
...
<section class="forvideo flex-column center">
        ...
        <div class="container flex-row space-around aligncenter video_container"> 
            ...
            <div class="text-for-video">
                ...
                <p>Что такое Марс для нас? </p>
               <p> Марс является символом надежды, романтики, достижений и перемен в одном лице.
               Нет ничего более символического и романтичного на Земле, что можно подарить любимому человеку.Это не причуда, с которой мы можем играть, это не то, что когда-либо потеряет свою привлекательность.
                Когда вы покупаете собственность на Марсе или на любой другой планете, пожалуйста, наслаждайтесь ею, потому что это то, что на самом деле круто!
               Вы можете посмотреть в ночное небо и сказать: «У меня есть часть этого!»</p>
            </div>
        </div>
</section>
...
<section>
    <div class="flex-row space-around container block-concept flex-m-column">
        ...
        <div class="flex-6 marsmap">
            <img src="/static/img/fmhome23.png" alt="Marsmap">
    </div>
...
<section class="s-stats">
    ...
    <div class="flex-row space-around center container stats-container">
...
<section>
    <div class="famous">
        ...
        <div>
            <div class="container flex-row space-between nowrap xm-scroll flex-m-column m-space-between">
